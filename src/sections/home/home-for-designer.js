    ...
    <Box sx={{ textAlign: { xs: 'center', md: 'unset' }, mt: { xs: 10, md: 20 } }}>
      ...
      <m.div variants={varFade().inUp}>
        ...
        <m.div variants={varFade().inUp}>
            ...
            >
                Los roles interactúan en un flujo que incluye: solicitud, aprobación, ejecución, revisión y seguimiento.
                Esto garantiza la eficiencia,
                responsabilidad y cooperación en cada etapa del proceso, optimizando la colaboración y resultados.            </Typography>
        </m.div>
